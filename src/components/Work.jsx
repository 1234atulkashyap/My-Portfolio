...
const projects = [
  {
    ...
    img: proj1,
    title: "Youtube Clone",
    liveUrl: "https://youtube-clone-iota-two.vercel.app/",
  },
  {
    id: 2,
    img: proj2,
    title: "CarHub",
    liveUrl: "https://car-hub-gamma-gules.vercel.app/",
  },
  {
    id: 3,
    img: proj3,
    title: "Portfolio",
    liveUrl: "https://my-portfolio-eta-indol.vercel.app/",
  },
  {
    id: 4,
    img: proj4,
...
const Work = () => {
  return (
    <div
      className="mx-auto max-w-[1200px] grid grid-cols-2 gap-8 glass p-6 m-5"
      id="work"
    >
